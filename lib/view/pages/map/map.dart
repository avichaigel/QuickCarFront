...
class _GMapState extends State<GMap> {
  ...
  void _setMarkerIcon() async {
    _markerIcon = BitmapDescriptor.fromBytes(
        await _getBytesFromAsset('assets/car-marker.png', 50));
  }
    ...
    cars.forEach((element) {
      _markers.add(Marker(
          ...
          infoWindow: InfoWindow(
            ...
            snippet: element.distanceFromLocation != null
                ? "${element.distanceFromLocation.toInt()} km away"
                : "",
          ),
          onTap: () {
            setState(() {
